...
image_size = (224, 224)  # ResNet152V2 standard input size
...
# Load pre-trained ResNet152V2 model without top layers
...
# Create a model by adding classification layers on top of ResNet152V2
model = Sequential([
    base_model,
...
model.save("resnet152v2_brain_tumor_model.h5")

# Fine-tuning the model by unfreezing some layers
# Unfreeze the last convolutional block of ResNet152V2
...
model.save("resnet152v2_brain_tumor_model_fine_tuned.h5")
