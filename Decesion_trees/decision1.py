...
y_valid_pred = dt_model.predict(X_valid_pca)
...
with open('decision_tree_brain_model.pkl', 'wb') as f:
    pickle.dump(model_data, f)

print("Decision Tree model saved successfully as 'decision_tree_brain_model.pkl'")
...
with open('decision_tree_results.txt', 'w') as f:
    ...
    f.write("\nFeature Importances:\n")
    for i in indices[::-1]:
        f.write(f"Feature {i}: {importances[i]:.4f}\n")

print("Results saved to 'decision_tree_results.txt'")
